    ...
    public partial class ZipFileTest_ConvenienceMethods : ZipFileTestBase
    {
        ...
        public void ExtractToDirectoryOverwrite()
        {
            ...
            using (var tempFolder = new TempDirectory(GetTestFilePath()))
            {
                ...
                Assert.Throws<System.IO.IOException>(() => ZipFile.ExtractToDirectory(zipFileName, tempFolder.Path /* default false */));
                Assert.Throws<System.IO.IOException>(() => ZipFile.ExtractToDirectory(zipFileName, tempFolder.Path, overwriteFiles: false));
        ...
        public void ExtractToDirectoryOverwriteEncoding()
        {
            ...
            using (var tempFolder = new TempDirectory(GetTestFilePath()))
            {
                ...
                Assert.Throws<System.IO.IOException>(() => ZipFile.ExtractToDirectory(zipFileName, tempFolder.Path, Encoding.UTF8 /* default false */));
                Assert.Throws<System.IO.IOException>(() => ZipFile.ExtractToDirectory(zipFileName, tempFolder.Path, Encoding.UTF8, overwriteFiles: false));
        ...
        public void ExtractToDirectoryZipArchiveOverwrite()
        {
            ...
            using (var tempFolder = new TempDirectory(GetTestFilePath()))
            {
                using (ZipArchive archive = ZipFile.Open(zipFileName, ZipArchiveMode.Read))
                {
                    ...
                    Assert.Throws<System.IO.IOException>(() => archive.ExtractToDirectory(tempFolder.Path /* default false */));
                    Assert.Throws<System.IO.IOException>(() => archive.ExtractToDirectory(tempFolder.Path, overwriteFiles: false));
