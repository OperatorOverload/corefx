...
namespace System.IO.Compression
{
    public static class ZipFile
    {
        ...
        public static void ExtractToDirectory(String sourceArchiveFileName, String destinationDirectoryName, Boolean overwrite=false)
        {
            ExtractToDirectory(sourceArchiveFileName, destinationDirectoryName, overwrite:overwrite, entryNameEncoding: null);
        }
        ...
        public static void ExtractToDirectory(String sourceArchiveFileName, String destinationDirectoryName, Encoding entryNameEncoding)
        {
            ...
            {
                archive.ExtractToDirectory(destinationDirectoryName, overwrite: false);
            }
        }
        ...
        ///     otherwise an <see cref="ArgumentException"/> is thrown.</para>
        /// </param>
        public static void ExtractToDirectory(String sourceArchiveFileName, String destinationDirectoryName, Boolean overwrite, Encoding entryNameEncoding)
        {
            if (sourceArchiveFileName == null)
                throw new ArgumentNullException(nameof(sourceArchiveFileName));
