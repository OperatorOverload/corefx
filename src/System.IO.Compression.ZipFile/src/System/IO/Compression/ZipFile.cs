...
namespace System.IO.Compression
{
    public static class ZipFile
    {
        ...
        /// <param name="destinationDirectoryName">The path to the directory on the file system. The directory specified must not exist, but the directory that it is contained in must exist.</param>
        /// <param name="overwriteFiles">True to indicate allow overwrite.  Note, this does not force a wipe, only overwrites any files with the same path/name.</param>
        ...
        {
            ExtractToDirectory(sourceArchiveFileName, destinationDirectoryName, overwriteFiles: false, entryNameEncoding: entryNameEncoding);
        }
